...
public class RunnableMoveMethodCreator extends RunnableCreator {

	private RefactoringBuilder refactoringBuilder;
	private IProject copiedProject; 
	
	public RunnableMoveMethodCreator(WizardController controller){
		super(controller);
			...
			public void run(IProgressMonitor monitor) {
				try {
					...
					if (copiedFile.exists()) {
						...
						Set<MoveMethodRefactoring> moveMethodRefactorings = refactoringBuilder.getMoveMethodRefactoring(compilationUnit, copiedFile);
						for(MoveMethodRefactoring refatoring : moveMethodRefactorings) {
